...
class SettingsViewController: UIViewController, SettingsView  {
    ...
    func deactivateAccount() {
        let deleteAccAlert = UIAlertController(title: "Deactivate your account",
        ...
        deleteAccAlert.addAction(UIAlertAction(title: "OK",
                                               style: .default,
    ...
    func showSuccess() {
        let removeDatAlert = UIAlertController(title: "Deactivate Your Account",
                                               message: "Your account has been deactivated.",
                                               preferredStyle: .alert)
        removeDatAlert.addAction(UIAlertAction(title: "OK",
                                               style: .default,
                                               handler: { [weak self] (action) in
    ...
    func showFailure(error: Error) {
        let failedAlert = UIAlertController(title: "Failed To Deactivate",
    ...
    func logOut() {
        let logOutAlert = UIAlertController(title: "Log Out",
                                            ...
                                            preferredStyle: .alert)
        logOutAlert.addAction(UIAlertAction(title: "Yes",
                                            style: .destructive,
                                            handler: { [weak self] (action) in
            self?.settingsPresenter.logOut()
        }))
        logOutAlert.addAction(UIAlertAction(title: "No",
                                            style: .default,
                                            handler: nil))
        DispatchQueue.main.async {
